...
adb install -r "%~dp0Courier-Android-v1.0.0.apk"
if %errorlevel% equ 0 (
    echo.
    echo [SUCCESS] Courier has been installed on your Android device!
) else (
    echo.
    echo [NOTE] You can also copy 'Courier-Android-v1.0.0.apk' directly to your phone storage and open it to install.
)
pause
